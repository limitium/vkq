 ...
 *
 * 1.5.2
 *             == Special thanks to <Ð”Ð¼Ð¸Ñ‚Ñ€Ð¸Ð¹ Ð Ð°Ð·ÑƒÐ¼Ð¾Ð²ÑÐºÐ¸Ð¹> ==
 ...
 *     <Ð˜Ð²Ð°Ð½Ð½ Ð•Ð»Ð¸Ð·Ð°Ñ€ÑŒÐµÐ²> and his vk_api.js based library).
 *
 * 1.4.4
 ...
 *
 * 1.4.2
 *               == Special thanks to <ÐÐ½Ð´Ñ€ÐµÐµÐ½ÐºÐ¾ ÐÑ€Ñ‚Ñ‘Ð¼> ==
 ...
 *
 * 1.4
 *             == Special thanks to <Ð›Ñ‘ÑˆÐºÐ° JIEXA ÐÑ€ÑÐµÐ½ÑŒÐµÐ²> ==
 ...
 * @copyright Â© 2010 Alexander Zubakov
 * @version 1.5.1
...
function vk_api(api_secret, oninit /* [, onfailure] [, test_mode] */) {
     ...
     * @var String
     */
    var msg_install = 'Ð”Ð»Ñ Ñ€Ð°Ð±Ð¾Ñ‚Ñ‹ Ð¿Ñ€Ð¸Ð»Ð¾Ð¶ÐµÐ½Ð¸Ñ ÐµÐ³Ð¾ Ð½ÐµÐ¾Ð±Ñ…Ð¾Ð´Ð¸Ð¼Ð¾ <a href="#" id="vk_api_msga">ÑƒÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ</a>';

    /**
     * Message to meke user set settings to application.
     * @var String
     */
    var msg_settings = 'Ð”Ð»Ñ Ñ€Ð°Ð±Ð¾Ñ‚Ñ‹ Ð¿Ñ€Ð¸Ð»Ð¾Ð¶ÐµÐ½Ð¸Ñ Ð½ÐµÐ¾Ð±Ñ…Ð¾Ð´Ð¸Ð¼Ð¾ ÑƒÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ Ñ‚Ñ€ÐµÐ±ÑƒÐµÐ¼Ñ‹Ðµ <a href="#" id="vk_api_msga">Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸</a>';
